...
if not platformOk:
    print("Please refer to https://github.com/wangyiqiu/dbscan-python for more specific system requirements. Please also make sure the latest version of the package (0.0.8) is installed.")
